...
using System.Text;
using DocReader.OfficeDrawing;
using System.Xml;
using DocReader.OpenXmlLib;
using DocReader.CommonTranslatorLib;
using DocReader.OfficeDrawing.Shapetypes;
...
namespace DocReader.WordprocessingMLMapping
{
          ...
          IMapping<ShapeType>
    {
        ...
        {
            if (!(shapeType is DocReader.OfficeDrawing.Shapetypes.OvalType))
            {
